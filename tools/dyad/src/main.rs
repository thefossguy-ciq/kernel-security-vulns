...
fn found_in(state: &DyadState, git_sha: &str) -> Vec<Kernel> {
...
fn main() {
    ...
    let mut vulnerable_commit_with_mainline_fix: std::collections::HashMap<String, String> =
        std::collections::HashMap::new();

    // First, separate the pairs by vulnerable git id
    let mut pairs_by_vuln_id: std::collections::HashMap<String, Vec<KernelPair>> =
        std::collections::HashMap::new();
